                            ...
                            <div id="js-product-list-top" class="row products-selection">
                                <div class="col-md-6 col-xs-6">
                                    ...
                                    <div class="hidden-sm-down total-products">
                                        <p id="numberOfProduct">{{__('translate-site/index.THERE_ARE')}} {{count($products) ?? '0'}} {{__('translate-site/index.PRODUCTS')}}.</p>
                                    </div>
                                </div>
                                <div class="col-md-6 col-xs-6">
                                ...
                                <div class="products product_list grid row" data-default-view="grid">
                                    @isset($products)
                                        @foreach($products as $product)
                                            <div class="item  col-lg-4 col-md-6 col-xs-12 text-center delete-product">
        ...
        $(document).on('click', '.removeFromWishlist', function (e) {
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    $('#numberOfProduct').html("There are " + data.products + " products.")
                }
            });
        });
